						...
						html += '<tr>'
							if (item.perfil != 3){
								if (item.estado === 'Registrado') {
									html += '<td><a href="functions/process_solicitud.php?accion=asignar&solicitud='+item.codigo+'" id="'+item.codigo+'" class="btn_elim"><img src="images/ico/plus24.png" width="20" heigth="20"/></a></td>'
								} else {
									html += '<td></td>'
								}								
								if (item.prioridad == 1){
